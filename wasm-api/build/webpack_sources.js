...
module.exports._sourcelistmap_map_generated_code_replace = function(arg0, arg1) {
    const ptr0 = arg0.ptr;
    arg0.ptr = 0;
    const [ptr1, len1] = passStringToWasm(arg1);
    return _SourceListMap.__construct(wasm._sourcelistmap_map_generated_code_replace(ptr0, ptr1, len1));
};
...
_list_map_sourcelistmap(arg0) {
    const ptr0 = arg0.ptr;
    arg0.ptr = 0;
    return _SourceListMap.__construct(wasm._replacesource__list_map_sourcelistmap(this.ptr, ptr0));
}
...
class _MSourceNode {
    ...
    const [ptr2, len2] = passStringToWasm(arg2);
    return _MSourceNode.__construct(wasm._msourcenode__new_number_number_string_null(arg0, arg1, ptr2, len2));
}
...
_to_string_with_source_map_string(arg0) {
    const [ptr0, len0] = passStringToWasm(arg0);
    const retptr = globalArgumentPtr();
    wasm._msourcenode__to_string_with_source_map_string(retptr, this.ptr, ptr0, len0);
    const mem = getUint32Memory();
    const ptr = mem[retptr / 4];
    const len = mem[retptr / 4 + 1];
    const realRet = getStringFromWasm(ptr, len).slice();
...
_to_string_with_source_map() {
    return JsSrcMap.__construct(wasm._sourcelistmap__to_string_with_source_map(this.ptr));
}
}
