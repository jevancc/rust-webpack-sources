...
module.exports._from_string_with_source_map = function(arg0, arg1, arg2, arg3) {
    ...
    return _SourceListMap.__construct(
        wasm._from_string_with_source_map(ptr0, len0, ptr1, ptr2, ptr3, len3)
    );
};
...
module.exports._sourcelistmap_map_generated_code_replace = function(
    arg0,
    arg1
) {
    const ptr0 = arg0.ptr;
    ...
    const [ptr1, len1] = passStringToWasm(arg1);
    return _SourceListMap.__construct(
        wasm._sourcelistmap_map_generated_code_replace(ptr0, ptr1, len1)
    );
};
...
module.exports.__wbg_f_new_number_number_string_new_number_number_string_SourceNode = function(
    arg0,
    arg1,
    arg2,
    arg3
...
module.exports.__wbg_f_add_add_sourcenode_SourceNode = function(arg0, arg1) {
    __wbg_f_add_add_sourcenode_SourceNode_target.call(
        getObject(arg0),
        getObject(arg1)
    );
};

const __wbg_f_setSourceContent_setSourceContent_SourceNode_target =
    SourceNode.prototype.setSourceContent;

module.exports.__wbg_f_setSourceContent_setSourceContent_SourceNode = function(
    arg0,
    arg1,
    arg2,
    arg3,
    ...
    __wbg_f_setSourceContent_setSourceContent_SourceNode_target.call(
        getObject(arg0),
        varg1,
        varg3
    );
...
class JsSrcMap {
    ...
    free() {
        const ptr = this.ptr;
        this.ptr = 0;
        wasm.__wbg_jssrcmap_free(ptr);
    }
    get_source() {
        const retptr = globalArgumentPtr();
        wasm.jssrcmap_get_source(retptr, this.ptr);
        const mem = getUint32Memory();
        const ptr = mem[retptr / 4];
        const len = mem[retptr / 4 + 1];
        const realRet = getStringFromWasm(ptr, len).slice();
    ...
    get_map_contents_len() {
        return wasm.jssrcmap_get_map_contents_len(this.ptr);
    }
    get_map_sources_len() {
        return wasm.jssrcmap_get_map_sources_len(this.ptr);
    }
    get_map_contents_nth(arg0) {
        const retptr = globalArgumentPtr();
        wasm.jssrcmap_get_map_contents_nth(retptr, this.ptr, arg0);
        const mem = getUint32Memory();
        const ptr = mem[retptr / 4];
        const len = mem[retptr / 4 + 1];
        const realRet = getStringFromWasm(ptr, len).slice();
    ...
    get_map_sources_nth(arg0) {
        const retptr = globalArgumentPtr();
        wasm.jssrcmap_get_map_sources_nth(retptr, this.ptr, arg0);
        const mem = getUint32Memory();
        const ptr = mem[retptr / 4];
        const len = mem[retptr / 4 + 1];
        const realRet = getStringFromWasm(ptr, len).slice();
    ...
    get_mappings() {
        const retptr = globalArgumentPtr();
        wasm.jssrcmap_get_mappings(retptr, this.ptr);
        const mem = getUint32Memory();
        const ptr = mem[retptr / 4];
        const len = mem[retptr / 4 + 1];
        const realRet = getStringFromWasm(ptr, len).slice();
...
module.exports.JsSrcMap = JsSrcMap;
...
class _SingleLineNode {
    ...
    static _new_string_string_string_number(arg0, arg1, arg2, arg3) {
        ...
        const [ptr2, len2] = passStringToWasm(arg2);
        return _SingleLineNode.__construct(
            wasm._singlelinenode__new_string_string_string_number(
                ptr0,
                len0,
                ptr1,
                len1,
...
class _SourceNode {
    ...
    static _new_string_string_string_number(arg0, arg1, arg2, arg3) {
        ...
        const [ptr2, len2] = passStringToWasm(arg2);
        return _SourceNode.__construct(
            wasm._sourcenode__new_string_string_string_number(
                ptr0,
                len0,
                ptr1,
                len1,
...
class _OriginalSource {
    ...
    static _new_string_string(arg0, arg1) {
        ...
        return _OriginalSource.__construct(
            wasm._originalsource__new_string_string(ptr0, len0, ptr1, len1)
        );
    }
    _source() {
        const retptr = globalArgumentPtr();
...
class _MSourceNode {
    ...
    static _new_number_number_string_null(arg0, arg1, arg2) {
        const [ptr2, len2] = passStringToWasm(arg2);
        return _MSourceNode.__construct(
            wasm._msourcenode__new_number_number_string_null(
                arg0,
                arg1,
                ptr2,
                len2
    ...
    _to_string_with_source_map_string(arg0) {
        const [ptr0, len0] = passStringToWasm(arg0);
        const retptr = globalArgumentPtr();
        wasm._msourcenode__to_string_with_source_map_string(
            retptr,
            this.ptr,
            ptr0,
            len0
...
class _SourceListMap {
    ...
    _add_node_string_string(arg0, arg1, arg2) {
        ...
        const [ptr1, len1] = passStringToWasm(arg1);
        const [ptr2, len2] = passStringToWasm(arg2);
        return wasm._sourcelistmap__add_node_string_string(
            this.ptr,
            ptr0,
            ptr1,
            len1,
    ...
    _prepend_node_string_string(arg0, arg1, arg2) {
        ...
        const [ptr1, len1] = passStringToWasm(arg1);
        const [ptr2, len2] = passStringToWasm(arg2);
        return wasm._sourcelistmap__prepend_node_string_string(
            this.ptr,
            ptr0,
            ptr1,
            len1,
    ...
    _to_string_with_source_map() {
        return JsSrcMap.__construct(
            wasm._sourcelistmap__to_string_with_source_map(this.ptr)
        );
    }
}
...
class _SourceMapSource {
    ...
    static _new_string_string_map(arg0, arg1, arg2, arg3, arg4, arg5) {
        const [ptr0, len0] = passStringToWasm(arg0);
        const [ptr1, len1] = passStringToWasm(arg1);
        const ptr2 = arg2.ptr;
        arg2.ptr = 0;
        ...
        return _SourceMapSource.__construct(
            wasm._sourcemapsource__new_string_string_map(
                ptr0,
                len0,
                ptr1,
                len1,
...
class _LineToLineMappedSource {
    ...
    static _new_string_string_string(arg0, arg1, arg2) {
        const [ptr0, len0] = passStringToWasm(arg0);
        const [ptr1, len1] = passStringToWasm(arg1);
        const [ptr2, len2] = passStringToWasm(arg2);
        return _LineToLineMappedSource.__construct(
            wasm._linetolinemappedsource__new_string_string_string(
                ptr0,
                len0,
                ptr1,
                len1,
